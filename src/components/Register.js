...
<div className={styles.formContainer}>
      ...
      <h2>Bienvenido a Dinobuss  <GiDinosaurRex/><br/><br/> Registrate para acceder a todos los beneficios!</h2>
      <form onSubmit={handleSumit}>
        <div className={styles.inputContainer}>
          <div className={styles.left}>
      <label htmlFor="email">CORREO</label>
      <input type="email"
      name="email" placeholder="ejemplo123@gmail.com"  onChange={handleChange
      }></input>
      </div>
      <svg
            viewBox="0 0 30 24"
