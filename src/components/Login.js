...
import dinobusimg from '../images/dinoBuss.jpg'
  ...
  return (
    <div>
      ...
      <div className={styles.formContainer}>
        <h2>
          Bienvenido a DinoBuss <GiDinosaurRex />
          <br />
          <br />
          Iniciar Sesion para obtener todos los beneficios de la plataforma!
        </h2>
        <form onSubmit={handleSumit}>
          ...
          <button onClick={handleGoogleSignin} className={styles.google}>Iniciar sesion con Google <FcGoogle/></button>
          <p>
          Ya tienes una cuenta?{" "}
          <b onClick={() => navigate("/register")}>Registrarse!</b>
        </p>
        </form>
